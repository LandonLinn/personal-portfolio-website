const PrimaryBtn = ({ btn_text, link_styles, primary_btn_classes, link, downloadFile, onClick }) => {
    return(
        <a href={link} className={link_styles} download={downloadFile} onClick={onClick}>
            <button 
