...
const About = () => {
    return(
        <Section sectionId='about' sectionClass="">
            <div className="col-span-full flex flex-col">
                <TaggedElement elementTag="h2" elementContent="About Me" elementContainerClass="justify-center"/>
            </div>

            <div className="col-span-full grid gap-x-5 gap-y-2 md:grid-cols-2 md:grid-rows-[200px_200px_auto]">
                {/* Image Wrapper */}
                ...
                <div className="">
                    ...
                    {/* Linnium */}
                    <TaggedElement elementHidden={"true"} elementTag={"h4"} elementContent={"Linnium - Founder & Consultant | Aug 2024 - Present"} elementHidden={"true"}/>
                    ...
                    {/* IBC */}
                    <TaggedElement elementTag={"h4"} elementClass={"mt-2"} elementContent={"IBC – Web Developer | May 2024 - Aug 2024"} elementHidden={"true"}/>
